...
# Translator bot:
# Spanish Agent output deta hai: "Translation: Hola amigo"
# Lekin aapko sirf "Hola amigo" chahiye.
# Iske liye custom_output_extractor likhte ho.

def extractor(output):
    return output.final_output.replace("Translation:", "").strip()
...
translate_to_spanish = translator_agent.as_tool(
	...
	tool_description="Translate user text to Spanish.",
	 custom_output_extractor=extractor # agar aapko agent ka raw output parse karke dusra format dena ho
)
